...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry, async_add_entities: AddEntitiesCallback):
    ...
    all_tasks_sensor: UdfordringerAllTasksSensor | None = None
    shop_sensor: UdfordringerShopSensor | None = None
    ui_sensor: UdfordringerUiSensor | None = None
...
class KidsChoresPointsSensor(SensorEntity):
    ...
    def __init__(self, store: KidsChoresStore, child_id: str):
        ...
        self._attr_unique_id = f"udfordringer_points_{ch.id}"
        self._attr_name = f"Udfordringer Points {ch.name}"
        self._attr_device_info = DeviceInfo(
            identifiers={(DOMAIN, f"child_{ch.id}")},
            name=f"Udfordringer – {ch.name}",
...
class UdfordringerAllTasksSensor(SensorEntity):
    _attr_has_entity_name = True
    _attr_name = "Udfordringer Tasks"
    _attr_unique_id = "udfordringer_tasks_all"

    def __init__(self, store: KidsChoresStore):
        self._store = store
        self._attr_device_info = DeviceInfo(
            identifiers={(DOMAIN, "tasks")},
            name="Udfordringer – Tasks",
            manufacturer="Udfordringer",
            model="Task Index",
        )
...
class UdfordringerUiSensor(SensorEntity):
    _attr_has_entity_name = True
    _attr_name = "Udfordringer UI"
    _attr_unique_id = "udfordringer_ui"

    def __init__(self, store: KidsChoresStore):
        self._store = store
        self._attr_device_info = DeviceInfo(
            identifiers={(DOMAIN, "ui")},
            name="Udfordringer – UI",
            manufacturer="Udfordringer",
            model="UI Settings",
        )
...
class UdfordringerShopSensor(SensorEntity):
    _attr_has_entity_name = True
    _attr_name = "Udfordringer Shop"
    _attr_unique_id = "udfordringer_shop"

    def __init__(self, store: KidsChoresStore):
        self._store = store
        self._attr_device_info = DeviceInfo(
            identifiers={(DOMAIN, "shop")},
            name="Udfordringer – Shop",
            manufacturer="Udfordringer",
            model="Point Shop",
        )
